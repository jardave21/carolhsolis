      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="mb-20">
          <div className="flex items-center gap-2 mb-8">
            ...
            <h2 className="text-3xl  font-anton">Sígueme en Instagram</h2>
          </div>
        ...
        <div className="font-open-sans">
          <div className="flex items-center gap-2 mb-8">
            ...
            <h2 className="text-3xl  font-anton">Último video</h2>
          </div>
          ...
          <div className={`transition-all duration-700 ${isVisible ? "opacity-100" : "opacity-0"}`}>
            <div className="group rounded-2xl overflow-hidden hover-elevate bg-muted/20 border border-border">
              ...
              <div className="p-6 font-open-sans">
                <h3 className="text-lg  font-poppins mb-2">{youtubeVideo.title}</h3>
                <a
                  href="#"
