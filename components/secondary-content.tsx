    ...
    <section id="libros" className="py-20 px-4 md:px-6 bg-background scroll-mt-28">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="text-center mb-16">
          <h2 className="text-3xl font-bold font-poppins text-foreground mb-4">Mis Libros</h2>
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-20">
          {books.map((book) => (
            <div key={book.title} className="text-center p-4 border-2 border-transparent hover:border-primary transition-all duration-300 rounded-lg">
